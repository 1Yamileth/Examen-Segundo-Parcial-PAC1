    ...
    public class TicketDB
    {
        ...
        public bool GuardarTicket(Ticket ticket)
        {
                ...
                try
                {
                    ...
                    sqlFactura.Append("INSERT INTO ticket VALUES (@CodigoTicket,@Fecha, @CodigoUsuario, @IdentidadCliente, @TipoSoporte, @DescripcionSolicitud, @DescripcionRespuesta, @Subtotal, @Impuesto,  @Descuento, @Total) ;");
                    ...
                    using (MySqlConnection conexion = new MySqlConnection(cadena))
                    {
                        ...
                        try
                        {
                            using (MySqlCommand cmd = new MySqlCommand(sqlFactura.ToString(), conexion))
                            {
                                ...
                                cmd.Parameters.Add("@Subtotal", MySqlDbType.Decimal).Value = ticket.Subtotal;
